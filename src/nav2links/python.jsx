...
export default function Python() {
  return (
    <div>
      ...
      <h4 className='pythonheaderfive ms-5'>An educational institution is a place where people of different ages gain an education, including preschools, childcare, primary-elementary schools, secondary-high schools, and universities. They provide a large variety of learning environments and learning spaces.</h4>
      ...
      <div className='pythonimg mt-5'></div>
      </div>
    </div>
  )
}
